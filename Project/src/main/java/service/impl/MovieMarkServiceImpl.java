...
import service.MovieMarkService;
...
public class MovieMarkServiceImpl implements MovieMarkService{
    ...
    private void init() {
        try {
            File file = new File("E:/Git/EAI/Project/src/main/resources/anti.txt");
        ...
        try {
            File file = new File("E:/Git/EAI/Project/src/main/resources/positive.txt");
            BufferedReader reader = new BufferedReader(new FileReader(file));
            String line = null;
            while ((line = reader.readLine()) != null) {
        ...
        try {
            File file = new File("E:/Git/EAI/Project/src/main/resources/negative.txt");
            BufferedReader reader = new BufferedReader(new FileReader(file));
            String line = null;
            while ((line = reader.readLine()) != null) {
        ...
        try {
            File file = new File("E:/Git/EAI/Project/src/main/resources/extreme.txt");
            BufferedReader reader = new BufferedReader(new FileReader(file));
            String line = null;
            while ((line = reader.readLine()) != null) {
                extremes.add(line);
        ...
        try {
            File file = new File("E:/Git/EAI/Project/src/main/resources/very.txt");
            BufferedReader reader = new BufferedReader(new FileReader(file));
            String line = null;
            while ((line = reader.readLine()) != null) {
                verys.add(line);
        ...
        try {
            File file = new File("E:/Git/EAI/Project/src/main/resources/more.txt");
            BufferedReader reader = new BufferedReader(new FileReader(file));
            String line = null;
            while ((line = reader.readLine()) != null) {
                mores.add(line);
        ...
        try {
            File file = new File("E:/Git/EAI/Project/src/main/resources/ish.txt");
            BufferedReader reader = new BufferedReader(new FileReader(file));
            String line = null;
            while ((line = reader.readLine()) != null) {
                ishs.add(line);
